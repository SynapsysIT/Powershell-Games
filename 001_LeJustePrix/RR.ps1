...
- Propreté du code (Respect des normes / Syntaxe PowerShell)
    1.5 / 2 - Bonne indentation, nom de variaibles parlantes, dommage pour l'utilisation de l'alias "cls" en lieu et place de la cmdlet Clear-Host et surtout utilisation d'un verb non officiel pour la fonction =)
